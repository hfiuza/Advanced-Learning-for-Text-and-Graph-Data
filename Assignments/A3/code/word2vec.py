...
for idx,token in enumerate(mft):
    ...
    mft_vecs[idx,:] = w2v.wv.word_vec(mft[idx])
...
print('WMD between sentence 1 and "the cat sat on the mat":', w2v.wv.wmdistance(s_1, [elt for elt in 'the cat sat on the mat'.split(' ') if elt not in stpwds]))
